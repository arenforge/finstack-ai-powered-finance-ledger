  ...
  return (
    <main className="auth-page">
      <form className="auth-card" onSubmit={submit}>
        ...
        <button className="primary-button" type="submit">{isSignup ? 'Create Account' : 'Login'}</button>
        <button className="ghost-button" type="button" onClick={google}>Continue with Google</button>
